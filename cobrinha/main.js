...
function changeDirection(commandNewDirection) {
  ...
  if (
    (direction === directions.UP && commandNewDirection === directions.DOWN) ||
    (direction === directions.DOWN && commandNewDirection === directions.UP) ||
    (direction === directions.RIGHT && commandNewDirection === directions.LEFT) ||
    (direction === directions.LEFT && commandNewDirection === directions.RIGHT)
    ) {
    moveSnake();
    moving = true;
    return;
